...
fetch("/api/Illuminance/3", {
                        ...
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('illuminance_chart_1'),
                                            config
                                        );
                                        console.log(config)
                                    });

fetch("/api/UV_index/3", {
                        method: "GET",
                        headers: headers
                        }).then(response => response.json())
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('uv_index_chart_1'),
                                            config
                                        );
                                        console.log(config)
                                    });

fetch("/api/Temperature/3", {
                        method: "GET",
                        headers: headers
                        }).then(response => response.json())
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('temperature_chart_1'),
                                            config
                                        );
                                        console.log(config)
                                    });

fetch("/api/Humidity/3", {
                        method: "GET",
                        headers: headers
                        }).then(response => response.json())
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('humidity_chart_1'),
                                            config
                                        );
                                        console.log(config)
                                    });

fetch("/api/Air_pressure/3", {
                        method: "GET",
                        headers: headers
                        }).then(response => response.json())
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('air_pressure_chart_1'),
                                            config
                                        );
                                        console.log(config)
                                    });

fetch("/api/Altitude/3", {
                        method: "GET",
                        headers: headers
                        }).then(response => response.json())
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('altitude_chart_1'),
                                            config
                                        );
                                        console.log(config)
                                    });

fetch("/api/Compensated_voc/3", {
                        method: "GET",
                        headers: headers
                        }).then(response => response.json())
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('compensated_voc_chart_1'),
                                            config
                                        );
                                        console.log(config)
                                    });