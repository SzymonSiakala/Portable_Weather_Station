...
fetch("/api/Illuminance/1", {
                        ...
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('illuminance_chart'),
                                            config
                                        );
                                        console.log(config)
                                    });

fetch("/api/UV_index/1", {
                        method: "GET",
                        headers: headers
                        }).then(response => response.json())
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('uv_index_chart'),
                                            config
                                        );
                                        console.log(config)
                                    });
...
fetch("/api/Air_pressure/1", {
                        ...
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('air_pressure_chart'),
                                            config
                                        );
                                        console.log(config)
                                    });

fetch("/api/Altitude/1", {
                        method: "GET",
                        headers: headers
                        }).then(response => response.json())
                        .then(data => {
...
fetch("/api/Compensated_voc/1", {
                        ...
                        .then(data => {
                                        ...
                                        const linechart = new Chart(
                                            document.getElementById('compensated_voc_chart'),
                                            config
                                        );
                                        console.log(config)
                                    });